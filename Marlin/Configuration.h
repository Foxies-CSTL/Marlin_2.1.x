...
#define TMC_HARDWARE_SERIAL            // Added by config.ini
#define Z_OFFSET -16.2                 // Added by config.ini
#define EXTRUDER_STEPS 1440            // Added by config.ini
#define XYZJERK 12                     // Added by config.ini
#define EJERK 5                        // Added by config.ini
#define XYZ_CURRENT 980                // Added by config.ini
#define XYZ_CURRENT_HOME 600           // Added by config.ini
#define E_CURRENT 380                  // Added by config.ini
#define DEFAULT_XYZ_STEPS_PER_UNIT ((XYZ_FULL_STEPS_PER_ROTATION) * (XYZ_MICROSTEPS) / double(XYZ_BELT_PITCH) / double(XYZ_PULLEY_TEETH)) // Added by config.ini
#define E_MICROSTEPS 32                // Added by config.ini
#define FIL_RUNOUT_PIN PA4             // Added by config.ini
#define MARLIN_EEPROM_SIZE EEPROM_PAGE_SIZE // Added by config.ini
#define NUM_SERIAL 1                   // Added by config.ini
#define PREHEAT_3_FAN_SPEED 0          // Added by config.ini
#define PREHEAT_3_LABEL "ABS"          // Added by config.ini
#define PREHEAT_3_TEMP_BED 90          // Added by config.ini
#define PREHEAT_3_TEMP_CHAMBER 35      // Added by config.ini
#define PREHEAT_3_TEMP_HOTEND 240      // Added by config.ini
#define PREHEAT_4_FAN_SPEED 200        // Added by config.ini
#define PREHEAT_4_LABEL "WOOD"         // Added by config.ini
#define PREHEAT_4_TEMP_BED 60          // Added by config.ini
#define PREHEAT_4_TEMP_CHAMBER 35      // Added by config.ini
#define PREHEAT_4_TEMP_HOTEND 200      // Added by config.ini
#define PREHEAT_5_FAN_SPEED 0          // Added by config.ini
#define PREHEAT_5_LABEL "TPU"          // Added by config.ini
#define PREHEAT_5_TEMP_BED 50          // Added by config.ini
#define PREHEAT_5_TEMP_CHAMBER 35      // Added by config.ini
#define PREHEAT_5_TEMP_HOTEND 230      // Added by config.ini
#define XYZ_BELT_PITCH 2               // Added by config.ini
#define XYZ_FULL_STEPS_PER_ROTATION 200 // Added by config.ini
#define XYZ_MICROSTEPS 32              // Added by config.ini
#define XYZ_PULLEY_TEETH 20            // Added by config.ini
#define MAIN_MENU_ITEM_10_CONFIRM      // Added by config.ini
#define MAIN_MENU_ITEM_10_DESC "Reboot Printer" // Added by config.ini
#define MAIN_MENU_ITEM_10_GCODE "M997" // Added by config.ini
#define MAIN_MENU_ITEM_6_CONFIRM       // Added by config.ini
#define MAIN_MENU_ITEM_6_DESC "1.Run Autotune on Active extruder" // Added by config.ini
#define MAIN_MENU_ITEM_6_GCODE "M306T\nM500\nG28\nM107" // Added by config.ini
#define MAIN_MENU_ITEM_7_CONFIRM       // Added by config.ini
#define MAIN_MENU_ITEM_7_DESC "1.Print_Test_Pattern in " PREHEAT_1_LABEL // Added by config.ini
#define MAIN_MENU_ITEM_7_GCODE "G28\nG29L1\nG26I0P4\nM500\nG28\nM117 Print Mesh Done" // Added by config.ini
#define MAIN_MENU_ITEM_8_CONFIRM       // Added by config.ini
#define MAIN_MENU_ITEM_8_DESC "2.Bed Level. UBL for " PREHEAT_2_LABEL // Added by config.ini
#define MAIN_MENU_ITEM_8_GCODE "G29L2\nM1004B80S2" // Added by config.ini
#define MAIN_MENU_ITEM_9_CONFIRM       // Added by config.ini
#define MAIN_MENU_ITEM_9_DESC "3.Bed Level. UBL for " PREHEAT_3_LABEL // Added by config.ini
#define MAIN_MENU_ITEM_9_GCODE "G29L3\nM1004B90S3" // Added by config.ini
#define MANUAL_FEEDRATE_XYZ 50*60      // Added by config.ini
...
//#define POLARGRAPH
  ...
  #define DEFAULT_SEGMENTS_PER_SECOND 80   // Move segmentation based on duration
...
//#define POLAR
#if ENABLED(POLAR)
  #define DEFAULT_SEGMENTS_PER_SECOND 80   // If movement is choppy try lowering this value
  #define PRINTABLE_RADIUS 130.0            // (mm) Maximum travel of X axis
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT { DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, EXTRUDER_STEPS }  
...
#define FILAMENT_RUNOUT_SENSOR
  ...
  #define FILAMENT_RUNOUT_DISTANCE_MM 190
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { 0, (Y_MAX_POS - 20), 80 }
