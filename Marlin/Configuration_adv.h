 ...
 */
  ...
  #define INTERPOLATE      true
    ...
    #define X_CURRENT_HOME  XYZ_CURRENT_HOME  // (mA) RMS current for homing. (Typically lower than *_CURRENT.)
...
//#define HOST_ACTION_COMMANDS     // Define on FLSUNQ_Config
  ...
  #if ALL(HOST_PROMPT_SUPPORT, TFT_BTT_UI) || ALL(HOST_PROMPT_SUPPORT, MOD_BTT_UI)
