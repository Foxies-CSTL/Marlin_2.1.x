...
#define COLOR_ORANGEFOX         0xED03 // OrangeFox
...
#define MOVE_AXIS_SCREEN  // Special "Move Axis" screen activated by touching coordinates area
  ...
  #define COLOR_BACKGROUND        COLOR_WHITE //COLOR_DARK
#endif
#ifndef COLOR_SELECTION_BG
  #define COLOR_SELECTION_BG      COLOR_ORANGE2 //COLOR_DARK_PURPLE
#endif
#ifndef COLOR_WEBSITE_URL
  #define COLOR_WEBSITE_URL       COLOR_ORANGE2 //COLOR_DODGER_BLUE
#endif
  ...
  #define COLOR_AXIS_HOMED        COLOR_DARK//COLOR_WHITE
#endif
...
#define COLOR_SD_ENABLED        COLOR_DARKGREY
#define COLOR_SD_DISABLED       COLOR_GREY

#ifndef COLOR_PROGRESS_FRAME
  #define COLOR_PROGRESS_FRAME    COLOR_DARKGREY//COLOR_DARK//COLOR_WHITE
#endif
  ...
  #define COLOR_STATUS_MESSAGE    COLOR_BLUE//COLOR_YELLOW
#endif

#ifndef COLOR_CONTROL_ENABLED
  #define COLOR_CONTROL_ENABLED   COLOR_DARK//COLOR_WHITE
#endif
  ...
  #define COLOR_MENU_TEXT         COLOR_BLUE //COLOR_WHITE //COLOR_YELLOW
#endif
#ifndef COLOR_MENU_VALUE
  #define COLOR_MENU_VALUE        COLOR_DARK //COLOR_WHITE
#endif

#define COLOR_MENU_VALUE_FONT    COLOR_ORANGE2

#ifndef COLOR_SLIDER
  #define COLOR_SLIDER            COLOR_DARK //COLOR_WHITE
#endif
#ifndef COLOR_SLIDER_INACTIVE
  #define COLOR_SLIDER_INACTIVE   COLOR_GREY
#endif

#define COLOR_INCREASE          COLOR_DARK
#define COLOR_DECREASE          COLOR_DARK
#define COLOR_TICK              COLOR_VIVID_GREEN

#ifndef COLOR_UBL
  #define COLOR_UBL               COLOR_DARK //COLOR_WHITE
#endif

#ifndef COLOR_TOUCH_CALIBRATION
  #define COLOR_TOUCH_CALIBRATION COLOR_MIDNIGHT_BLUE//COLOR_WHITE
#endif
